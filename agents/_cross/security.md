...
checklist:
  ...
  - "Check untrusted input and injection surfaces"
  - "Check secrets, logs, and error disclosure"
  - "Check dependency and build integrity"
  - "Assign severity based on impact and exploitability"
  - "Redact sensitive values from findings"
origin: orchestkit/security-auditor@9.8.0
version: 1
---
