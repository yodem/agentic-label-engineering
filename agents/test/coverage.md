---
name: test-coverage
description: "Coverage specialist: measures coverage, ranks the gaps by risk and fills them with focused tests."
role: test
sub: coverage
...
Use coverage gaps to select meaningful tests across unit, integration, API, end-to-end, and component boundaries.
