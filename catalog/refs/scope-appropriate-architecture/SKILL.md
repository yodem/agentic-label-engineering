origin: orchestkit/skills/scope-appropriate-architecture@9.8.0
---
...
Load on demand with `Read("${CLAUDE_PLUGIN_ROOT}/skills/scope-appropriate-architecture/references/<file>")`:
| File | Content |
|------|---------|
