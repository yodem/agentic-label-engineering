origin: orchestkit/skills/design-to-code/SKILL.md@9.8.0

---
name: design-to-code
license: MIT
compatibility: "Claude Code 2.1.220+. Optional: stitch (official Google Stitch), 21st-dev-magic, storybook-mcp (@storybook/addon-mcp) MCP servers."
